...
def generate_launch_description():
  ...
  declare_exploration_planner_config = DeclareLaunchArgument('exploration_planner_config', default_value='matterport_sim', description='')
  ...
  start_semantic_mapping_node = IncludeLaunchDescription(
    PythonLaunchDescriptionSource(
      [get_package_share_directory('semantic_mapping'), '/semantic_mapping_sim.launch']),
    launch_arguments={
    }.items()
  )
  ...
  start_detection_node = IncludeLaunchDescription(
    PythonLaunchDescriptionSource(
      [get_package_share_directory('semantic_mapping'), '/detection_node.launch']),
    launch_arguments={
    }.items()
  )
